...
function dummyCall({ personaServiceA5, ticket, payload, res }:
  { personaServiceA5: PersonaServiceA5; ticket: any; payload: IPayload; res: express.Response; }): void | PromiseLike<void> {
